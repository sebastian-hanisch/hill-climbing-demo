"""Kandidatenlisten + Don't-Look-Bits (hc_dlb.py): Permutation, Laengenbuchhaltung, Monotonie, Determinismus,
Bewertungsbudget; bei kleinen Instanzen echte 2-opt-Optima (gegen hc_algorithm.is_local_optimum, unabhaengig von
